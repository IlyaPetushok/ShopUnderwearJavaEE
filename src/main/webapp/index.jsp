        ...
        <div class="shop-items">
            <div class="shop-item">
                <div class="shop-item-photo">
                    <img src="<%=request.getContextPath()%>/front/image/shop-item/item1.jpg" alt="shop">
                </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><p class="shop-item-data">
                                <input id="shop-input-color-1" type="hidden" name="item-color" value="white">
                                <div id="item-color-1" class="shop-item-color" data-title="белый" value="white"></div>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <td><p>Цена:</p></td>
                            <td><p class="shop-item-data">85 б.р</p></td>
                        </tr>
                        <tr>
                            <td>
                                <button id="shop-item-button-corsina-1" onclick="ButtonClickCorsina(1)">В корзину
                                </button>
                            </td>
                            <td>
